#!/usr/bin/env python3
"""
Pretty print Toucan out/prepare jsonl for human inspection.

Example:
  python src/cli/pretty_toucan_prepare.py -i out/prepare/Toucan-1.5M/000_00000.jsonl -n 1
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Pretty print Toucan out/prepare jsonl")
